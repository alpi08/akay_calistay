(() => {
  ...
  const translations = {
    tr: {
      ...
      about:{eyebrow:'',title:'Misyon ve Vizyonumuz',lead:'',missionLabel:'',missionTitle:'Bilgiyi paylaş,<br>ufku genişlet.',missionText:'Akay Çalıştayı olarak misyonumuz; gençlerin hızla gelişen ve değişen dünyaya dair farkındalıklarını artırırken, fikirlerini özgürce ifade edebilecekleri güçlü bir bilgi paylaşım alanı sunmaktır. Akademik olarak geliştirici ve günlük hayatı etkileyen konularla çok yönlü bakış açıları kazandırmayı hedefliyoruz.',visionLabel:'',visionTitle:'Köklere bak,<br>geleceği kur.',visionText:'Akay Perspektif ve Aydınlanma Çalıştayı ekibi olarak gençlerin Türk kültürünü ve kökenini, dünya tarihini, farklı kültürleri ve dilleri anlayarak entelektüel donanımı ve hitabet becerisi yüksek bireyler olmalarına katkı sunmayı amaçlıyoruz. Nihai hedefimiz, bilgiyi ve aydınlık zihinleri insanlığa somut faydaya dönüştürmektir.'},
