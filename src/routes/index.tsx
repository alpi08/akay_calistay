...
const TITLE = "Akay Perspektif ve Aydınlanma Çalıştayı | 24 Eylül 2026";
const DESCRIPTION =
  "Gençlerin fikirlerini özgürce paylaştığı, perspektif ve aydınlanma odaklı çalıştay. 24 Eylül 2026'da düzenleniyor.";
